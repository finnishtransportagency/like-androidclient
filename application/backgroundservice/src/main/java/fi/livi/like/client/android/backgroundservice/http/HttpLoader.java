...
import fi.livi.like.client.android.backgroundservice.http.tasks.JourneyUpdatePostTask;
import fi.livi.like.client.android.backgroundservice.http.tasks.UserLoadingTask;
