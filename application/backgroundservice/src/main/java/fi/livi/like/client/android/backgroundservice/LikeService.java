package fi.livi.like.client.android.backgroundservice;
...
import fi.livi.like.client.android.backgroundservice.http.NetworkMonitor;
...
public class LikeService implements UserLoadingCompletedReceiver.Listener, UserManager.Listener, NetworkMonitor.Listener {
    ...
    public void onUserLoadingCompleted() {
        log.info("onUserLoadingCompleted - " + dataStorage.getUser());
        if (userLoadingCompletedReceiver != null) {
    ...
    public TrackingStrings getTrackingStrings() {
        return userTracker.getTrackingStrings();
    }
